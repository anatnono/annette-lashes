...
const services = [
  {
    icon: Lashes,
    title: 'הלחמת ריסים',
    description: 'קלאסית, ווליום, מגה ווליום, וויספי, ועוד.. התאמה מדויקת לצורת העין ולסגנון שלך. ריסים עם מראה מלא ומרשים, עם חומרים איכותיים שמחזיקים עד 4 שבועות.',
  },
  {
    icon: LashLift,
    title: 'הרמת ריסים + גבות',
    description: 'הרמה לריסים ולגבות למראה טבעי ומראה מורם. בלי ריסים מלאכותיים — התוצאה היא עיניים פקוחות ומוארות. נשמר עד 8 שבועות.',
  },
  {
    icon: GlueLash,
    title: 'הדבקת ריסים',
    description: 'הדבקת ריסים בשיטה שלי שמותאמת לעיניים שלך ולמבנה הפנים שלך. חוסך התעסקות במסקרה. מחזיק עד 3 שבועות.',
  },
  {
    icon: Brows,
    title: 'עיצוב גבות',
    description: 'עיצוב מדויק בשעווה ובפינצטה — מסגור מושלם לפנים. התאמה אישית למבנה הפנים, לצורת העין ולסגנון שמחמיא לך.',
  },
  {
    icon: Makeup,
    title: 'איפור כלות וערב',
    description: 'איפור מקצועי לכל האירועים, מותאם אישית לסגנון שלך ולמבנה הפנים שלך. איפור שנשאר עמיד עם מוצרים איכותיים שמחזיקים כל הלילה.',
  },
];
